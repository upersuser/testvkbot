...
SERVICE_OVERRIDING_DIR=/etc/app
SERVICE_ENV_CFG=/etc/app/env.cfg
SERVICE_LOG_DIR=/var/log/app
SERVICE_TMP_DIR=/tmp

JAR_FILE=$SERVICE_HOME/testvkbot.jar
...
APP_OPTS="-Dlog.dir=$SERVICE_LOG_DIR\
          ...
          -Dupersuser.config.location=$SERVICE_CONF_DIR\
          -DPORT=$PORT"
